...
public class RegistrationTests implements BaseApi {
    ...
    public void registrationNegativeTest_ExRes400() throws IOException {
        ...
        softAssert.assertTrue(errorMessage.getMessage().toString().contains("At least 8 characters;Must contain at least 1 uppercase letter, 1 lowercase letter, and 1 number"));
